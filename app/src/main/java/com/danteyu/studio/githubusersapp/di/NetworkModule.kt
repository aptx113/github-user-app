...
import com.danteyu.studio.githubusersapp.BASE_URL
...
object NetworkModule {
    ...
    @Singleton
    @Provides
    fun provideApiService(retrofit: Retrofit): GitHubUsersApiService =
        retrofit.create(GitHubUsersApiService::class.java)
}
